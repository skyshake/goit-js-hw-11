...
function renderGallery(hits) {
    const markup = hits.map(({ webformatURL , largeImageURL , tags , likes , views , comments , downloads , user ,  })=>{
        return `
...
async function handleSubmit(e) {
    ...
    if (loadText.className === "text") loadText.classList.add("loader");
    if ((0, _pixabayApiJs.options).params.q === "") return;
    (0, _pixabayApiJs.options).params.page = 1;
    galleryEl.innerHTML = "";
    reachedEnd = false;
    try {
        const response = await (0, _axiosDefault.default).get((0, _pixabayApiJs.BASE_URL), (0, _pixabayApiJs.options));
...
async function loadMore() {
    ...
    try {
        ...
        loadText.classList.remove("loader");
        (0, _notiflixNotifyAio.Notify).failure("You reached the limit!");
    }
}
...
},{"axios":"jo6P5","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","./pixabay-api.js":"4M0T7","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","../css/styles.css":"1CY4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kaxSc":[function() {},{}],"1CY4s":[function() {},{}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequired7c6")
